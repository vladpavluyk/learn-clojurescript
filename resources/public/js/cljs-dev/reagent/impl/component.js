...
if((i < len)){
var k = (ks[i]);
var G__1690 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__1691 = (i + (1));
m = G__1690;
i = G__1691;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__1693 = c;
var G__1693__$1 = (((G__1693 == null))?null:G__1693.prototype);
if((G__1693__$1 == null)){
return null;
} else {
return (G__1693__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__1695 = c;
var G__1695__$1 = (((G__1695 == null))?null:G__1695.prototype);
if((G__1695__$1 == null)){
return null;
} else {
return (G__1695__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__1698__delegate = function (args){
return reagent.impl.component.as_element.call(null,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
var G__1698 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__1699__i = 0, G__1699__a = new Array(arguments.length -  0);
while (G__1699__i < G__1699__a.length) {G__1699__a[G__1699__i] = arguments[G__1699__i + 0]; ++G__1699__i;}
  args = new cljs.core.IndexedSeq(G__1699__a,0,null);
} 
return G__1698__delegate.call(this,args);};
G__1698.cljs$lang$maxFixedArity = 0;
G__1698.cljs$lang$applyTo = (function (arglist__1700){
var args = cljs.core.seq(arglist__1700);
return G__1698__delegate(args);
});
G__1698.cljs$core$IFn$_invoke$arity$variadic = G__1698__delegate;
return G__1698;
})()
;})(c,f,_,res))
:res);
...
var _STAR_current_component_STAR__orig_val__1702 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__1703 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__1703;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__1702;
}});
...
return ((function (G__1704,G__1704__$1){
...
var c = this;
var G__1709_1711 = (c["cljsRatom"]);
if((G__1709_1711 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__1709_1711);
}
...
var renders_1713 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_1714 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_1713));
if((cljs.core.count.call(null,renders_1713) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_1713))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_1714)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_1714)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__1712 = name;
switch (G__1712) {
case "":
...
var G__1716 = o;
(G__1716[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__1717 = fiber;
var G__1717__$1 = (((G__1717 == null))?null:(G__1717["type"]));
if((G__1717__$1 == null)){
return null;
} else {
return (G__1717__$1["displayName"]);
}
})();
var parent = (function (){var G__1718 = fiber;
if((G__1718 == null)){
return null;
} else {
return (G__1718["return"]);
}
})();
var path = (function (){var G__1719 = parent;
var G__1719__$1 = (((G__1719 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__1719));
if((G__1719__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1719__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__1721 = c;
if((G__1721 == null)){
return null;
} else {
return (G__1721["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__1722._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__1724 = c;
if((G__1724 == null)){
return null;
} else {
return (G__1724["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__1726 = c;
if((G__1726 == null)){
return null;
} else {
return G__1726._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__1728 = instance;
if((G__1728 == null)){
return null;
} else {
return (G__1728["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__1729 = instance;
if((G__1729 == null)){
return null;
} else {
return G__1729._currentElement;
}
}
})();
var name = (function (){var G__1730 = elem;
var G__1730__$1 = (((G__1730 == null))?null:(G__1730["type"]));
if((G__1730__$1 == null)){
return null;
} else {
return (G__1730__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__1732 = elem;
if((G__1732 == null)){
return null;
} else {
return (G__1732["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__1733._owner;
}
}
})();
var path = (function (){var G__1734 = owner;
var G__1734__$1 = (((G__1734 == null))?null:reagent.impl.component.component_path.call(null,G__1734));
if((G__1734__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1734__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__1735 = c;
var G__1735__$1 = (((G__1735 == null))?null:G__1735.constructor);
if((G__1735__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__1735__$1);
}
}
})();
